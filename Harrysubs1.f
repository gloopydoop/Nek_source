...
!----------------------------------------------------------------------------
      if(IBM_MAP_RHO.eq.1)then
         ! Test this one later
            qa=IBM_QA_ramp
            do i=1,ntot1
            H_tmp(i,1,1,1)  = IBM_AMPMSK_MIN + 
     $ ( IBM_AMPMSK - IBM_AMPSK_MIN)* (1.0 - IBM_SUBS1(i,1,1,1))
      ...
      elseif(IBM_MAP_RHO.eq.2)then
            ...
            do i=1,ntot1
            H_tmp(i,1,1,1)  = IBM_AMPMSK_MIN + 
     $   (IBM_AMPMSK - IBM_AMPMSK_MIN)*(1.0 - IBM_SUBS1(i,1,1,1))**p_
            H_tmp(i,1,1,1)  = -H_tmp(i,1,1,1) / vtrans(i,1,1,1,1)
      ...
      elseif(IBM_MAP_RHO.eq.3)then
            do i=1,ntot1
            H_tmp(i,1,1,1)  = IBM_AMPMSK_MIN + 
     $ (IBM_AMPMSK - IBM_AMPMSK_MIN)*(1.0 - IBM_SUBS1(i,1,1,1))
            H_tmp(i,1,1,1)  = -H_tmp(i,1,1,1) / vtrans(i,1,1,1,1)
            !H_tmp(i,1,1,1) = H_tmp(i,1,1,1) / bm1(i,1,1,1)
            enddo
      endif
