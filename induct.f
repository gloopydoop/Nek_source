...
c      logical ifproj
     ...
     $               ,H2_x(LX1,LY1,LZ1,LELV ) 
     $               ,H2_y(LX1,LY1,LZ1,LELV ) 
     $               ,H2_z(LX1,LY1,LZ1,LELV ) 
...
!                 ! HARRYm you have to do anisotropic
!         call rzero(H2_ROB,N) ! ROBIN_BC
!         call bcneusc_mod(H2_ROB,1) ! ROBIN_BC
!         call add3 (H2_x,H2,H2_ROB,N) ! ROBIN_BC
!         call rzero(H2_ROB,N) ! ROBIN_BC
!         call bcneusc_mod(H2_ROB,2) ! ROBIN_BC
!         call add3 (H2_y,H2,H2_ROB,N) ! ROBIN_BC
!         if(if3d) then
!         call rzero(H2_ROB,N) ! ROBIN_BC
!         call bcneusc_mod(H2_ROB,3) ! ROBIN_BC
!         call add3 (H2_z,H2,H2_ROB,N) ! ROBIN_BC
!         endif
C------------------------------------------------------------------!
