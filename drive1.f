...
c-----------------------------------------------------------------------
      ...
      ! HARRY this is mad sketchy, but you need to modify kstep
      ! HARRY come back to this... this was the only way you could get
      ! revolve to work for multiple cycles. You've switched it off for
      ! SHS but you may have fucked revolve....
      integer kstep
      !common /harrykstep/ kstep
     ...
     &     ' running solver in post processing mode'
      ...
      do kstep=1,nsteps,msteps
         ...
         if(kstep.ge.nsteps) then
            lastep = 1
            if(NIO.eq.0) write(6,*) 'HARRY: drive1 LASTEP', kstep,
     $ nsteps, msteps
         endif
         call check_ioinfo  
         call set_outfld
